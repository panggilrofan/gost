                        ...
                        <div class="table-cell">
                            <div class="intro-text">
                                ...
                                <div class="title clearfix">
                                    <a href="#about" class="btn btn-trnsp btn-big smooth_scroll">About US</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-text">
                        <h3 class="subtitle"><span>Fyr</span>Creative</h3>
                        <p>
                            FyrCreative adalah software house yang berada di Jember. </br>
                            FyrCreative melayani jasa pembuatan aplikasi berbasis Web dan Desain Grafis.
                        </p>
                        <i class="fa fa-chevron-right"></i><strong class="subtitle2"> Visi</strong>
                        <ul>
                            <li>Menjadikan FyrCreative inspirasi bagi software house lainnya.</li>
                        </ul></br>
                ...
                <div class="home-services">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="service-box">
                            ...
                            <h3 class="subtitle">Maintenance Website</h3>
                            <p>
                                Kami juga melayani jasa maintenance website, baik untuk memperbaiki ataupun mempercantik website Anda.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="service-box">
                            ...
                            <h3 class="subtitle">Desain Grafis</h3>
                            <p>
                                Kami melayani jasa desain grafis logo, banner, brosur dan lain-lain.
                            </p>
                        </div>
                    </div>
