			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item active">
						<a class="nav-link" href="<?php echo base_url('admin/portofolio/editPortofolio') ?>">
			...
			<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="index.php?page=profile">Edit Portofolio</a>
					</div>
						...
						<div class="col-md-8">
							...
							<div class="card">
								<div class="card-header card-header-success">
									...
									<p class="card-category">Edit data lama</p>
								</div>
								<div class="card-body">
									<form action="<?= base_url('admin/portofolio/editPortofolio') ?>" method="post" enctype="multipart/form-data">
										<div class="row">
											<div class="col-sm-6">
